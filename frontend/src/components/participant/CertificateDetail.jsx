...
//                         <h4 className="h6 fw-bold text-dark mb-0">Verifikasi kode QR</h4>
//                       </div>
//                       <p className="text-muted small mb-3">
//                         Sertifikat ini dilengkapi dengan kode QR yang dapat digunakan untuk memverifikasi keasliannya.
//                       </p>
//                       <Link
//                         to="/verify"
