  ...
  const handleMouseUp = () => {
    if (isSelecting && preview) {
      ...
      if (width < MIN_SIZE || height < MIN_SIZE) {
        alert(`Area QR terlalu kecil. Minimal ${MIN_SIZE}x${MIN_SIZE} pixel.`);
        return;
      }
      
      if (width > MAX_SIZE || height > MAX_SIZE) {
        alert(`Area QR terlalu besar. Maksimal ${MAX_SIZE}x${MAX_SIZE} pixel.`);
        return;
      }
      ...
      {!preview ? (
        ...
        <div className="canvas-container">
          <div className="d-flex justify-content-between align-items-center mb-3 p-3 bg-light rounded-3">
            ...
            <button 
              onClick={resetUpload} 
              className="button radius-30 button-sm button-outline"
          ...
          {enableSelection && (
            <div className="alert mt-3 small mb-0" role="status" aria-live="polite">
