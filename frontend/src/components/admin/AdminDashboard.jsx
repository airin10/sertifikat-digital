...
//           <div className="card border-0 shadow-sm admin-recent-certificates">
...
//           <p>© Mikroskil {new Date().getFullYear()}</p>
//         </div>
//       </div>
//     </div>
//   );
...
// //               style={{ width: '40px', height: '40px', background: 'linear-gradient(135deg, #F5C842, #D4AF37)' }}
// //             >
// //               {/* Ganti ICON_COLORS.white ke '#FFFFFF' atau sesuaikan */}
// //               <CheckCircle color="#FFFFFF" size={22} />
// //             </div>
// //             <div>
// //               <h1 className="h6 fw-bold text-dark mb-0">Dasbor Admin</h1>
...
// //                 <p className="text-muted small mb-0">Tambah, ubah, atau hapus data peserta</p>
// //               </div>
// //             </Link>
// //           </div>
...
// //                 <p className="text-muted small mb-0">Unggah dan tandatangani sertifikat baru dengan kode QR</p>
// //               </div>
// //             </Link>
// //           </div>
...
// //                 <p className="text-muted small mb-0">Lihat dan kelola seluruh sertifikat</p>
// //               </div>
// //             </Link>
// //           </div>
// //         </div>
