...
def main():
    ...
    print("\nPilih opsi:")
    print("1. Full Reset (hapus semua data + buat ulang)")
    print("2. Buat Admin Baru saja (tanpa reset)")
    print("3. Cek Koneksi Database saja")
    ...
    if choice == '1':
        ...
        if create_first_admin():
            ...
            print_warning("Admin creation failed, but database is ready")
            
    elif choice == '2':
        if not check_mysql_connection():
            print_error("Tidak bisa lanjut karena koneksi MySQL gagal")
            sys.exit(1)
        ...
        if create_first_admin():
            ...
            print_error("Gagal membuat admin")
