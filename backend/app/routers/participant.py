...
from app.auth_service import get_current_participant, get_current_user
...
def download_certificate(
    ...
    if cert.is_revoked:
        raise HTTPException(status_code=403, detail="Sertifikat telah dicabut")
    ...
    return FileResponse(
        ...
        filename=f"{certificate_id}_final.png"  
    )
